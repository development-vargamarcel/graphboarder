...
const getObjIndexInArray = (arr: QMSFieldItem[] = [], obj: QMSFieldItem = {} as QMSFieldItem, getIdentifierValue: GetIdentifierValueFn): number => {
...
export const Create_QMSFieldToQMSGetMany_Store = (initialValue: QMSFieldItem[] = []): QMSFieldToQMSGetManyStore => {
