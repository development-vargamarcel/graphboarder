<script>
	...
	/** @type {{nodes: any, parentNodeId: any, parentNode?: any, node: any, availableOperators: any, group: any, type: any, originalNodes: any, prefix?: string, addDefaultFields: any, showSelectModal: any}} */
	let {
		nodes = $bindable(),
		parentNodeId,
