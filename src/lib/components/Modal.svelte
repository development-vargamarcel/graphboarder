...
<!-- scroll-smooth -->
<div
	class="fixed top-0 right-0 z-40  h-screen  w-screen md:w-[170vh]  overflow-y-scroll overscroll-contain   bg-base-100/50  "
	bind:this={mainDiv}
...
>
	{#if mainDivIntroEnd}
		...
		<div
			...
			my-0 max-h-min space-y-0 rounded-b-none border-transparent bg-base-100 p-0 py-0 mx-auto  md:w-[80vh]"
			in:fly={{
				delay: 20,
				duration: 300,
				x: 0,
	...
	{/if}
	{#if showApplyBtn}
		<div class="fixed bottom-0  right-0 z-50 w-full 	 md:w-[170vh]">
			<!-- card-actions -->
			<div
				class="my-0  mx-auto w-full  md:w-2/5  mx-auto justify-center bg-gradient-to-t from-base-100/100 via-base-100/70 to-base-100/10 px-2 pb-0"
			>
				<div class=" mx-auto w-11/12    md:pb-4 ">
					<button
