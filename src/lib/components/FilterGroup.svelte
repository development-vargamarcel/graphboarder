<script>
	...
	let detail;
	let inputEl;
	/** @type {{containerEl: any, id: any, choises: any, title: any, modalTitle?: any, type: any, chosenDefault: any, chosen: any, extraData: any, chosenInputField: any, rawValue?: string, isINPUT_OBJECT?: boolean}} */
	let {
		containerEl,
		id,
		choises = $bindable(),
